...
public class ZhubanfangController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		ZhubanfangEntity user = zhubanfangService.selectOne(new EntityWrapper<ZhubanfangEntity>().eq("mingcheng", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		
                if("否".equals(user.getSfsh())) return R.error("账号已锁定，请联系管理员审核。");
		String token = tokenService.generateToken(user.getId(), username,"zhubanfang",  "主办方" );
    ...
    public R register(@RequestBody ZhubanfangEntity zhubanfang){
    	...
    	ZhubanfangEntity user = zhubanfangService.selectOne(new EntityWrapper<ZhubanfangEntity>().eq("mingcheng", zhubanfang.getMingcheng()));
		if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        ZhubanfangEntity user = zhubanfangService.selectById(id);
    ...
    public R resetPass(String username, HttpServletRequest request){
        ...
        user.setMima("123456");
        zhubanfangService.updateById(user);
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ZhubanfangEntity> wrapper = new EntityWrapper<ZhubanfangEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = zhubanfangService.selectCount(wrapper);
