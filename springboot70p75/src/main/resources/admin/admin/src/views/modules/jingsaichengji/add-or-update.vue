<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="竞赛编号" prop="jingsaibianhao">
          <el-input v-model="ruleForm.jingsaibianhao" 
              placeholder="竞赛编号" clearable  :readonly="ro.jingsaibianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="竞赛编号" prop="jingsaibianhao">
              <el-input v-model="ruleForm.jingsaibianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="竞赛标题" prop="jingsaibiaoti">
          <el-input v-model="ruleForm.jingsaibiaoti" 
              placeholder="竞赛标题" clearable  :readonly="ro.jingsaibiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="竞赛标题" prop="jingsaibiaoti">
              <el-input v-model="ruleForm.jingsaibiaoti" 
                placeholder="竞赛标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="竞赛分类" prop="jingsaifenlei">
          <el-input v-model="ruleForm.jingsaifenlei" 
              placeholder="竞赛分类" clearable  :readonly="ro.jingsaifenlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="竞赛分类" prop="jingsaifenlei">
              <el-input v-model="ruleForm.jingsaifenlei" 
                placeholder="竞赛分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.jingsaifengmian" label="竞赛封面" prop="jingsaifengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.jingsaifengmian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="竞赛成绩" prop="jingsaichengji">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jingsaichengji" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jingsaichengji" label="竞赛成绩" prop="jingsaichengji">
                    <span v-html="ruleForm.jingsaichengji"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  data() {
	...
	shhf : false,
      ...
      rules: {
          ...
          jingsaifenlei: [
                { required: true, message: '竞赛分类不能为空', trigger: 'blur' },
          ],
          jingsaididian: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.mingcheng!=''&&json.mingcheng){
                this.ruleForm.mingcheng = json.mingcheng
	    		this.ro.mingcheng = true;
		}
	...
	this.ruleForm.jingsaichengji = this.ruleForm.jingsaichengji.replace(reg,'../../../springboot70p75/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
