<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于微信小程序的大学生科技竞赛管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='zhubanfang'" class="input-group">
			   <div class="label">名称</div>
			   <div class="input-container">
			     <input v-model="ruleForm.mingcheng" class="input" type="text" placeholder="名称">
			   </div>
			 </div> -->
			<el-form-item label="名称" class="input" v-if="tableName=='zhubanfang'">
			  <el-input v-model="ruleForm.mingcheng" autocomplete="off" placeholder="名称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zhubanfang'" class="input-group">
			...
			<el-form-item label="负责人" class="input" v-if="tableName=='zhubanfang'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='zhubanfang'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='zhubanfang'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="手机号码" class="input" v-if="tableName=='zhubanfang'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='zhubanfang'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱"  />
			</el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `zhubanfang` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
