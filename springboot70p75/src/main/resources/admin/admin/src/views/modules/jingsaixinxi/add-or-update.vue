  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jingsaibianhao" label="竞赛编号" prop="jingsaibianhao">
              <el-input v-model="ruleForm.jingsaibianhao" 
                placeholder="竞赛编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="竞赛分类" prop="jingsaifenlei">
          <el-select :disabled="ro.jingsaifenlei" v-model="ruleForm.jingsaifenlei" placeholder="请选择竞赛分类">
            <el-option
...
export default {
  ...
  methods: {
	...
	this.ruleForm.jingsaineirong = this.ruleForm.jingsaineirong.replace(reg,'../../../springboot70p75/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
