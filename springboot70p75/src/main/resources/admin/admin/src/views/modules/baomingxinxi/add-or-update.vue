<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="截至时间" prop="jiezhishijian">
          <el-input v-model="ruleForm.jiezhishijian" 
              placeholder="截至时间" clearable  :readonly="ro.jiezhishijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="截至时间" prop="jiezhishijian">
              <el-input v-model="ruleForm.jiezhishijian" 
